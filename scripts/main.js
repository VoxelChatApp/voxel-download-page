...
let currentDownloadUrl = 'https://github.com/VoxelChatApp/voxel-download-page/releases/download/v1.0.105/Voxel-Setup-1.0.105.exe';
let currentVersion = '1.0.105';
let currentFileSize = '138 MB';
let currentFileName = 'Voxel-Setup-1.0.105.exe';
